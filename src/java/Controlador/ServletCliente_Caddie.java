 ...
 * @author user
 */
@WebServlet(name = "ServletCliente_Caddie", urlPatterns = {"/ServletCliente_Caddie"})
public class ServletCliente_Caddie extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String CliCaCodigo,CliCaCliId,CliCaCaId,CliCaFHSer,CliCaCalific,CliCaTalega;
         ...
         ClienteCaddie ing=new ClienteCaddie();
         ing.ingresarClienteCaddie(inggs);
